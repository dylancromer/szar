...
so_b_clust="userdata/so/base/fisher_dc_SO-v3_base_40_owl2_v1.1_2019-06-04-19-57-52-EDT_1e-2photoz.pkl"
so_b_clust_abias="userdata/so/base/fisher_dc_SO-v3_base_40_owl2_v1.1_2019-06-04-20-40-48-EDT_1e-2photoz_abias.pkl"

#SO goal files
so_g_abund="userdata/so/goal/savedFisher_SO-v3-goal-40_grid-owl2_owl2_v1.1_no_planck.pkl"
so_g_clust="userdata/so/goal/fisher_dc_SO-v3_goal_40_owl2_v1.1_2019-06-04-20-20-21-EDT_1e-2photoz.pkl"
so_g_clust_abias="userdata/so/goal/fisher_dc_SO-v3_goal_40_owl2_v1.1_2019-06-04-20-49-51-EDT_1e-2photoz_abias.pkl"

#S4 files
s4_abund="userdata/s4/savedFisher_S4-1.0-CDT_grid-owl2_owl2_v1.1_no_planck.pkl"
s4_clust="userdata/s4/fisher_dc_S4-1.0-CDT_grid-owl2_v1.1_2019-06-04-20-28-47-EDT_1e-2photoz.pkl"
s4_clust_abias="userdata/s4/fisher_dc_S4-1.0-CDT_grid-owl2_v1.1_2019-06-04-20-58-33-EDT_1e-2photoz_abias.pkl"
